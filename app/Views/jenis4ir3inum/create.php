<?= view('layout/header', ['title' => 'Tambah Jenis Air Minum']) ?>
  ...
  <div class="layout-inner">
    ...
    <div class="layout-container">
      ...
      <div class="container-fluid container-p-y">
        ...
        <!-- Header -->
        <h4 class="font-weight-bold mb-3">Tambah Jenis Air Minum</h4>

        <!-- Form -->
        <div class="card">
          <div class="card-body">

            <form action="<?= base_url('jenis4ir3inum/store') ?>" method="post">
