  ...
  <div class="layout-inner">
    ...
    <div class="layout-container">
      ...
      <div class="container-fluid container-p-y">
        ...
        <form action="<?= base_url('profilekurir/update') ?>" method="post">
          <div class="card p-4">
            <div class="mb-3">
              <label>Nama Kurir</label>
              <input type="text" name="nama_kurir" class="form-control" 
                     value="<?= esc($kurir['nama_kurir']) ?>" required>
            </div>
            <div class="mb-3">
              <label>Telepon</label>
              <input type="text" name="telepon" class="form-control" 
                     value="<?= esc($kurir['telepon']) ?>" required>
            </div>
            <div class="mb-3">
              <label>Username</label>
              <input type="text" name="username" class="form-control" 
                     value="<?= esc($kurir['username']) ?>" required>
            </div>
            <div class="mb-3">
